...
@WebServlet(name = "procesadores", urlPatterns = { "/procesadores" })
public class ProcesadoresServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Producto> todosLosProductos = gp.filtrarPorCategoria(1); // Filtrar productos de categoría 1 (Procesadores)
