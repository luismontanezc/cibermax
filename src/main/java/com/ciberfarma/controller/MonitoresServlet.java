 ...
 */
@WebServlet(name = "monitores", urlPatterns = { "/monitores" })
public class MonitoresServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Producto> todosLosProductos = gp.filtrarPorCategoria(8); // Filtrar productos de categoría 8
