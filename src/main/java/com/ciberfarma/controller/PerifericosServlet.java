...
@WebServlet(name = "perifericos", urlPatterns = { "/perifericos" })
public class PerifericosServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Producto> todosLosProductos = gp.filtrarPorCategoria(9); // Filtrar productos de categoría 9 (Periféricos PC)
